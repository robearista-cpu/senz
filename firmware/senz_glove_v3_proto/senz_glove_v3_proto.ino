 ...
 * senz_glove_v3_proto
 * -------------------
 * v3 PROTOTYPE bring-up firmware: wrist + index + thumb IMUs + 8 Velostat taxels.
 * Board: ESP32-S3-DevKitC-1.  Pin layout: docs/PINOUT_v3_proto.txt.
 *
 ...
 *        6 thumb-meta  GPIO39   (MPU-9250, WHO=0x71, 9-axis; mag not read)
 *        7 hand-dorsum GPIO38   back-of-hand / palm frame (MPU-9250 recommended)
 *      Driver accepts BOTH 0x70 and 0x71, so 6500 + 9250 mix on one bus.
 *   - 1x BNO055 wrist IMU (I2C 0x28, on-chip NDOF fusion -> quaternion)
 *   - 15x Velostat force taxels via CD74HC4067 (SIG=GPIO10 ADC1, S0..S3=6,7,15,16)
 ...
 * host/force_pipeline.py (turns forceN into relative grip).
 *
 *   # senz-v3proto nimu=7 nforce=8 rate=200
 *   # columns: t_us,bno_qw,bno_qx,bno_qy,bno_qz,imu0_ax,...,imu6_gz,force0..force7
...
// ============================================================================
// CONFIG -- see docs/PINOUT_v3_proto.txt (single source of truth for pins)
// ============================================================================
...
// --- Velostat force array (CD74HC4067) ---
...
Preferences prefs;
static const char *NVS_NS = "senz-v3p";
...
// ============================================================================
void printBanner() {
  Serial.printf("# senz-v3proto nimu=%u nforce=%u rate=%lu\n",
